...
<html class="no-js" lang="">
    <head>
        ...
        <style type="text/css">
            .flex-wrap input[type=radio] {
              position: fixed;
              left: -100px;
            }

            .flex-wrap input:not([type=radio]) {
              appearance: none;
...
<!-- 
    ...
    <section class="login-section">
        <div class="container-fluid no-padding">
            <div class="">                
                <div class="col-md-offset-5 col-md-6 no-padding">
                    <div class="login-box">
                        <div class="flex-wrap">
                            <div class="login-social">
                                <ul class="list-unstyled">
                                    <li><a href="javascript:;" class="gbg"><span><i class="fa fa-google-plus"></i></span>Google</a></li>
                                    <li><a href="javascript:;" class="fbg"><span><i class="fa fa-facebook"></i></span>Facebook</a></li>
                                    <li><a href="javascript:;" class="tbg"><span><i class="fa fa-twitter"></i></span>Twitter</a></li>
                                </ul>
                            </div>  
                            <div class="choice">
                                <h4>OR</h4>
                            ...
                            <fieldset>
                                <form action validate>
                                    ...
                                    <input class="sign-up sign-in reset top-inp" type="email" placeholder="Email" />
